  ...
  let group_table = $(`
    <table id="${id_prefix}" class="ui-widget-content" width="100%">
        <tr id="${id_prefix}_header">
            <th id="${id_prefix}_header_p" width="99%">Permissions for <br><span id="${id_prefix}_header_username"></span>
            </th>
...
$("#filestructure").after(
  '<div id="sidepanel" style="display:inline-block;width:250px;margin:20px;"></div>'
);
